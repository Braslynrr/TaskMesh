...
export default function LoginClient({ expired }: { expired?: string }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="w-full max-w-sm space-y-4">
        {expired && <span className="text-sm text-red-500">Your session has expired. Please log in again.</span>}
        <form onSubmit={handleSubmit} className="space-y-4 rounded border p-6">
          ...
          <button type="submit" className="w-full rounded bg-gray-200 px-3 py-2 text-black hover:bg-white">
            Log in
          </button>
        </form>
